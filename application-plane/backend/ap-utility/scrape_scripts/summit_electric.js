// summit_electric client scrape script (test flow, hand-written).
//
...
// "SuperSecretPassword!". The extraction waits for the secure-area flash message
// and reports a fixed bill total and due date.
//
...
var EXTRACTION = () => {
  ...
  return {
    bills: [{ due_date: "2026-07-23", total: 287.64 }],
    usage: []
  };
};
